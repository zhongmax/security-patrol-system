package com.csmaxwell.sps.base.generator;
...
/**
 * MyBatisPlus代码生成器
 * Created by maxwell on 2021/1/16.
 */
public class MyBatisPlusGenerator {

    public static void main(String[] args) {
        String projectPath = System.getProperty("user.dir") + "/sps-base";
    ...
    private static GlobalConfig initGlobalConfig(String projectPath) {
        ...
        globalConfig.setAuthor("maxwell");
    ...
    private static StrategyConfig initStrategyConfig(String[] tableNames) {
        ...
        // 去掉表前缀
        // strategyConfig.setTablePrefix("sps_");
